...
> **Mantra:** _If it needs a comment to be understood, it needs a rewrite first._

---

## 15 · Documentation References (Read Before Coding)

> These files are the source of truth. Agent MUST read relevant doc before implementing.

| Task | Read This First |
|------|----------------|
| Creating any class | [`docs/solid-principles.md`](docs/solid-principles.md) |
| Choosing a pattern | [`docs/design-patterns.md`](docs/design-patterns.md) |
| Defining types / interfaces | [`docs/interface-contracts.md`](docs/interface-contracts.md) |
| Writing any backend layer | [`docs/agent-directives.md`](docs/agent-directives.md) |
| Architecture questions | [`docs/system-architecture.md`](docs/system-architecture.md) |
| Naming / conventions | [`docs/code-standards.md`](docs/code-standards.md) |
| Feature scope / requirements | [`docs/project-overview-pdr.md`](docs/project-overview-pdr.md) |
| What exists / what's missing | [`docs/codebase-summary.md`](docs/codebase-summary.md) |
