        ...
        <div className="flex flex-1 items-center gap-3 w-full sm:w-auto">
          ...
          <div className="relative flex-1 sm:max-w-[280px]">
            <input
              ...
              className="w-full pl-4 pr-9 py-2 text-[13px] border border-slate-200 rounded-md bg-white focus:outline-none focus:border-primary transition-all"
            />
          ...
          <div className="relative min-w-[160px]">
            <select
              ...
              className="w-full appearance-none pl-4 pr-9 py-2 text-[13px] border border-slate-200 rounded-md bg-white focus:outline-none focus:border-primary transition-all text-slate-600"
            >
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
              <ChevronRight className="text-slate-400 rotate-90" size={14} />
            </div>
          </div>
          ...
          <button
            ...
            className="text-[13px] font-medium text-slate-600 bg-slate-100 hover:bg-slate-200 transition-colors px-4 py-2 rounded-md"
          >
            Thiết lập lại
          </button>
          <button
      ...
      <div className="bg-white flex flex-col">
        <div className="overflow-x-auto">
          <table className="w-full text-[13px] text-left">
            <thead className="bg-slate-50/50 border-y border-slate-200 text-slate-600 font-semibold whitespace-nowrap">
              <tr>
                  ...
                  <td colSpan={mode === "manage" ? 8 : 6} className="h-[400px] text-center">
                    <div className="flex flex-col items-center justify-center gap-4 text-slate-400">
                      <div className="relative flex items-center justify-center w-24 h-24">
                        ...
                        <div className="bg-slate-200 h-1 w-16 absolute -bottom-2 rounded-full"></div>
                        <FileText className="text-slate-500 z-10" size={48} strokeWidth={1} />
                      </div>
                      <p className="font-medium text-slate-500 text-[13px] mt-2">
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-center">
                      <div className="flex justify-center">
                        <span
                          className={`inline-flex items-center justify-center px-4 py-1.5 text-[11px] font-bold border rounded-full bg-transparent ${
