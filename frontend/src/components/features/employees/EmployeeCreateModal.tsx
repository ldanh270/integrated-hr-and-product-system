...
const createSchema = z.object({
  ...
  employeeType: z.enum(["full_time", "part_time", "contractor", "intern"]),
          ...
          <form id="create-employee-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input id="fullName" {...register("fullName")} placeholder="Nhập họ tên" className={errors.fullName ? "border-destructive" : ""} />
                {errors.fullName && <p className="text-xs text-destructive">{errors.fullName.message}</p>}
              </div>
              
              <div className="space-y-1.5">
                <Label htmlFor="username">Username *</Label>
                <Input id="username" {...register("username")} placeholder="Nhập username" className={errors.username ? "border-destructive" : ""} />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input id="email" type="email" {...register("email")} placeholder="Nhập email" className={errors.email ? "border-destructive" : ""} />
                {errors.email && <p className="text-xs text-destructive">{errors.email.message}</p>}
              </div>
              
              <div className="space-y-1.5">
                <Label htmlFor="password">Mật khẩu *</Label>
                <Input id="password" type="password" {...register("password")} placeholder="Mật khẩu tạm" className={errors.password ? "border-destructive" : ""} />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                >
                  <option value="employee">Nhân sự thường (Employee)</option>
