    ...
    <div className={cn("flex flex-col items-center justify-center py-8 text-center", className)}>
      ...
      >
        ...
        <rect
          ...
          strokeDasharray="3 3"
        />
        <line x1="42" y1="42" x2="58" y2="42" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <line x1="42" y1="50" x2="54" y2="50" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <line x1="42" y1="58" x2="50" y2="58" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </svg>
