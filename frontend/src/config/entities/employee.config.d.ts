...
export declare const EMPLOYEE_ROLES: readonly ["employee", "team_leader", "hr_manager", "general_manager", "admin"];
export type IEmployeeRole = (typeof EMPLOYEE_ROLES)[number];
export declare const ROLE_LABELS: Record<string, string>;
export declare const EMPLOYEE_STATUS_LABELS: Record<string, string>;
export declare const EMPLOYEE_TYPE_LABELS: Record<string, string>;
