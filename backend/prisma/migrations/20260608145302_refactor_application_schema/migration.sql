/*
  ...
  - You are about to drop the column `regimeType` on the `ApplicationLeaveDetail` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "ApplicationLeaveDetail" DROP COLUMN "regimeType",
ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "documentUrl" TEXT,
ADD COLUMN     "leaveType" "LeaveType" NOT NULL;

-- AlterTable
ALTER TABLE "ApplicationOvertimeDetail" ADD COLUMN     "expectedMinutes" INTEGER;
...
-- CreateIndex
CREATE INDEX "ApplicationLeaveDetail_leaveType_idx" ON "ApplicationLeaveDetail"("leaveType");
