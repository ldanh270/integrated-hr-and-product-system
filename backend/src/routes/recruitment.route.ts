...
router.get("/requisitions/:id/workspace", requirePermission(PERMISSION_CODE.RECRUITMENT_READ), (req, res, next) => controller.getRequisitionWorkspace(req as AuthRequest, res, next))
router.get("/requisitions/:id/activities", requirePermission(PERMISSION_CODE.RECRUITMENT_READ), (req, res, next) => controller.getRequisitionActivities(req as AuthRequest, res, next))
router.get("/requisitions/:id/stages", requirePermission(PERMISSION_CODE.RECRUITMENT_READ), (req, res, next) => controller.listRequisitionStages(req as AuthRequest, res, next))
router.post("/requisitions/:id/stages", requirePermission(PERMISSION_CODE.RECRUITMENT_POSTING_MANAGE), (req, res, next) => controller.createRequisitionStage(req as AuthRequest, res, next))
router.put("/requisitions/:id/stages/reorder", requirePermission(PERMISSION_CODE.RECRUITMENT_POSTING_MANAGE), (req, res, next) => controller.reorderRequisitionStages(req as AuthRequest, res, next))
router.patch("/requisitions/:id/stages/:stageId", requirePermission(PERMISSION_CODE.RECRUITMENT_POSTING_MANAGE), (req, res, next) => controller.updateRequisitionStage(req as AuthRequest, res, next))
router.delete("/requisitions/:id/stages/:stageId", requirePermission(PERMISSION_CODE.RECRUITMENT_POSTING_MANAGE), (req, res, next) => controller.deleteRequisitionStage(req as AuthRequest, res, next))
router.post("/requisitions/:id/stages/move", requirePermission(PERMISSION_CODE.RECRUITMENT_UPDATE), (req, res, next) => controller.moveRequisitionApplication(req as AuthRequest, res, next))
