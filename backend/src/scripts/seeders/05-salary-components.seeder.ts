    ...
    const componentsToCreate = [
      {
        ...
        formula: "baseSalary * (workingDays / standardWorkingDays)",
      ...
      },
      {
        name: "Overtime Pay",
        type: "addition" as any,
        formula: "(baseSalary / standardWorkingDays / 8) * 1.5 * (overtimeMinutes / 60)",
      ...
      },
      {
        ...
        type: "deduction" as any,
        formula: "(baseSalary / standardWorkingDays / 8) * (lateMinutes + earlyLeaveMinutes) / 60",
