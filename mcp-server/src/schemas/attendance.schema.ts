...
export const GetAttendanceSchema = z
  .object({
    startDate: z
      .string()
...
export const OverrideScheduleSchema = z
  .object({
    employeeId: z.string().describe("ID of the employee"),
...
export const SubmitShiftChangeSchema = z
  .object({
    ...
    swapWithEmployeeId: z
      .string()
      .optional()
      .describe("ID of the employee to swap with (optional)"),
    swapWithShiftId: z
      .string()
      .optional()
...
export const RejectShiftChangeSchema = z
  .object({
